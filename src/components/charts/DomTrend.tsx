      ...
      {filteredData.length > 0 && (
        <div className="mt-6 grid grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <div className="bg-red-50 p-3 rounded-lg">
            <div className="text-sm text-red-600 font-medium">Avg Days on Market</div>
            <div className="text-lg font-bold text-red-800">
              {Math.round(filteredData.reduce((sum, item) => sum + item.mediandom, 0) / filteredData.length)}
            </div>
          </div>
          <div className="bg-green-50 p-3 rounded-lg">
            <div className="text-sm text-green-600 font-medium">Peak Listings</div>
            <div className="text-lg font-bold text-green-800">
              {Math.max(...filteredData.map(item => item.listings)).toLocaleString()}
            </div>
          </div>
          <div className="bg-orange-50 p-3 rounded-lg">
            <div className="text-sm text-orange-600 font-medium">Fastest Market</div>
