    ...
    <Card className="mb-12 bg-white/90 backdrop-blur-sm border border-gray-200/50 shadow-lg rounded-xl">
      <CardHeader className="pb-4">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div>
            <CardTitle className="text-2xl font-bold text-slate-800 uppercase tracking-wide">SINGLE FAMILY | PROPERTIES</CardTitle>
            <CardDescription className="text-slate-600 mt-2">Comprehensive market data by price range</CardDescription>
          </div>
