    ...
    <Card className="mb-12 bg-white/70 backdrop-blur-sm border-white/20 hover:shadow-2xl transition-all duration-300">
      <CardHeader>
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div>
            <CardTitle className="text-2xl text-slate-800">Property Market Analysis</CardTitle>
            <CardDescription className="text-slate-600">Comprehensive market data by price range</CardDescription>
          </div>
